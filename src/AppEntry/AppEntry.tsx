...
import likedPhotosByUserId from "../../likedPhotos.json";

const loggedInUser: UserType = {
  id: 1,
  fullName: "John Smith",
  username: "jsmith",
  profile_image: "https://s3.us-west-2.amazonaws.com/Photos.unsplash.com/small/photo-1657861970480-268922fa3732",
  likedPhotos: likedPhotosByUserId["1"],
};

console.log(loggedInUser.likedPhotos);
